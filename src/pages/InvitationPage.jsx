  ...
  return (
    ...
    >
      ...
      <div className="max-w-2xl mx-auto space-y-12">
        {config.openingQuote && (
          <div className="text-center px-4 py-6 rounded-2xl"
        ...
        {config.dressCode && <DressCode dressCode={config.dressCode} />}

        <div className="flex flex-col items-center gap-4 bg-white/50 backdrop-blur-sm p-6 rounded-2xl">
        ...
        <div className="text-center py-8 border-t border-gray-200 space-y-3">
